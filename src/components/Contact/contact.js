        ...
        <form name="contact" netlify>
          <div className="input-area">
            <input
              ...
              autoComplete="off"
            />
            <label className="label-name" for="fast-name">
          ...
          <div className="input-area">
            <input
              ...
              autoComplete="off"
            />
            <label className="label-name" for="last-name">
              <span className="content-name">Фимилия</span>
            </label>
          </div>
          ...
          <div className="input-area">
            ...
            <label className="label-name" for="message">
              <span className="content-name">Дополнительная информация</span>
            </label>
          </div>
...
const ContactWrapper = styled.section`
  ...
  .content-container {
    ...
    h2 {
      ...
      background: -webkit-linear-gradient(45deg, #46fcea, #fb713f);
